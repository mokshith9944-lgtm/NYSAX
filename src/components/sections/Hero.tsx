    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="tracking-widest uppercase text-[11px]">STUDIO STATUS: ACTIVE FOR Q3/Q4</span>
          <span className="text-white/20">|</span>
          <span className="text-silver-400 text-[11px] hidden sm:inline">BANGALORE & GLOBAL</span>
        </motion.div>
        ...
        <motion.p
          ...
          data-cursor="text"
        >
          Nysa Agency bridges strategic discipline, bespoke editorial design, and full-stack web engineering to launch enduring commercial products.
        </motion.p>
